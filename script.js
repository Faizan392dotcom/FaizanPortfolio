...
//     const animateElements = document.querySelectorAll('.stat-card, .feature-card, .timeline-content, .project-card, .skill-category, .contact-card');
